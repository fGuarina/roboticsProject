...
TRIG = 16	# output pin which triggers the sensor
ECHO = 18	# input pin which reads the return signal from the sensor
...
def main() :
	# create the node
	rospy.init_node('Left_sonar')
	
	# instantiate the publisher
	pub = rospy.Publisher('left_sonar_channel', Float64, queue_size = 1)
