...
const String window_threshold_name = "Result";
...
int main(int argc, char* argv[]) {
    ...
    // RGB frame, HSV frame and the final result of the threshold
    Mat frame, frame2, frame_HSV, frame_threshold;
    ...
    while (true) {
        ...
        imshow(window_threshold_name, frame_threshold);
